...
@:native("XML") extern class XML {
   ...
   */
  function setSettings(obj:Dynamic):Dynamic;
  /*
   ...
   */
  function insertChildAfter(child1:XML, child2:XML):Array;
  /*
   ...
   * @param {XML} child2 The XML to insert.
   */
  function insertChildBefore(child1:XML, child2:XML):Array;
  /*
