...
@:native("File") extern class File {
   ...
   */
  function openDialog(prompt:String, filter:Dynamic, multiSelect:Bool):File;
  /*
   ...
   */
  function saveDialog(prompt:String, filter:Dynamic):File;
  /*
   ...
   * @param {Boolean} [multiSelect] When true, the user can select multiple files and the return value is an array.
   */
  function openDlg(prompt:String, filter:Dynamic, multiSelect:Bool):File;
  /*
   ...
   * @param {any} [filter] In Windows only, a filter that limits the types of files displayed in the dialog.
   */
  function saveDlg(prompt:String, filter:Dynamic):File;
  /*
   ...
   */
  function createAlias(path:String):String;
  /*
