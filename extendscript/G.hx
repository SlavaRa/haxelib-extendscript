...
@:native("$") extern class G {
   ...
   */
  static function write(text:Dynamic):String;
  /*
   * Prints text to the Console, and adds a newline character.
   * @param {any} text The text to print. All arguments are concatenated.
   */
  static function writeln(text:Dynamic):String;
  /*
   ...
   */
  static function bp(condition:Dynamic):String;
  /*
   ...
   */
  static function setenv(name:String, value:String):String;
  /*
   * Suspends the calling thread for a number of milliseconds.
   * @param {Number} msecs Number of milliseconds to sleep.
   */
  static function sleep(msecs:Float):String;
  /*
   ...
   */
  static function evalFile(file:File, timeout:Float):Dynamic;
  /*
