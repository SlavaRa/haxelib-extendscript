...
typedef PDF = {
   ...
   */
  var pdfAttributes:PDFAttribute;
  /*
   * Clipping path settings.
   */
  var clippingPath:ClippingPathSettings;
  /*
   * Graphic layer option settings.
   */
  var graphicLayerOptions:GraphicLayerOption;
  /*
   ...
   */
  var grayVectorPolicy:PlacedVectorProfilePolicy;
  /*
   * The color profile policy for RGB content in a placed vector.
   */
  var rgbVectorPolicy:PlacedVectorProfilePolicy;
  /*
   * The color profile policy for CMYK content in a placed vector.
   */
  var cmykVectorPolicy:PlacedVectorProfilePolicy;
  /*
  ...
  /*
   * The swatch (color, gradient, tint, or Dynamic ink) applied to the fill of the PDF. . Can also accept: String.
   */
  ...
  /*
   * The swatch (color, gradient, tint, or Dynamic ink) applied to the stroke of the PDF. Can also accept: String.
   */
   ...
   */
  function placeXML(using:XMLElement):Asset;
  /*
   ...
   * @param {Dynamic} [around] The point around which to flip the PDF. Can accept: Array of 2 Units or AnchorPoint enumerator. 
   */
  function flipItem(given:Flip, around:Dynamic):Dynamic;
  /*
   * Duplicates the PDF at the specified location or offset.
   * @param {Dynamic} [to] The location of the new PDF, specified in coordinates in the format [x, y]. Can accept: Array of 2 Units, Spread, Page or Layer. 
   * @param {Dynamic} [by] Amount by which to offset the new PDF from the original PDF's position. 
   */
   ...
   * @param {Dynamic} [to] The new location of the PDF,in the format (x, y). Can accept: Array of 2 Units, Spread, Page or Layer. 
   * @param {Dynamic} [by] The amount (in measurement units) to move the PDF relative to its current position, in the format (x, y). 
   */
