...
typedef CharacterStyleGroup = {
   ...
   */
  function duplicate():CharacterStyleGroup;
  /*
   ...
   */
  function move(to:LocationOptions, reference:Dynamic):CharacterStyleGroup;
  /*
   * Deletes the style.
   * @param {Dynamic} [replacingWith] The style to apply in place of the deleted style. Can accept: ParagraphStyle or CharacterStyle. 
   */
  function remove(replacingWith:Dynamic):CharacterStyleGroup;
  /*
   * Sets the label to the value associated with the specified key.
   * @param {String} key The key.
   * @param {String} value The value.
   */
  function insertLabel(key:String, value:String):CharacterStyleGroup;
  /*
   ...
   */
  function getElements():CharacterStyleGroup;
  /*
