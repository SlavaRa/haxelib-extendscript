...
typedef TextBox = {
  ...
  /*
   * The swatch (color, gradient, tint, or Dynamic ink) applied to the fill of the TextBox. . Can also accept: String.
   */
  ...
  /*
   * The swatch (color, gradient, tint, or Dynamic ink) applied to the stroke of the TextBox. Can also accept: String.
   */
   ...
   * @param {Dynamic} [around] The point around which to flip the TextBox. Can accept: Array of 2 Units or AnchorPoint enumerator. 
   */
  function flipItem(given:Flip, around:Dynamic):Dynamic;
  /*
   * Duplicates the TextBox at the specified location or offset.
   * @param {Dynamic} [to] The location of the new TextBox, specified in coordinates in the format [x, y]. Can accept: Array of 2 Units, Spread, Page or Layer. 
   * @param {Dynamic} [by] Amount by which to offset the new TextBox from the original TextBox's position. 
   */
   ...
   * @param {Dynamic} [to] The new location of the TextBox,in the format (x, y). Can accept: Array of 2 Units, Spread, Page or Layer. 
   * @param {Dynamic} [by] The amount (in measurement units) to move the TextBox relative to its current position, in the format (x, y). 
   */
