...
typedef Oval = {
  ...
  /*
   * The swatch (color, gradient, tint, or Dynamic ink) applied to the fill of the Oval. . Can also accept: String.
   */
  ...
  /*
   * The swatch (color, gradient, tint, or Dynamic ink) applied to the stroke of the Oval. Can also accept: String.
   */
   ...
   * @param {Dynamic} [around] The point around which to flip the Oval. Can accept: Array of 2 Units or AnchorPoint enumerator. 
   */
  function flipItem(given:Flip, around:Dynamic):Dynamic;
  /*
   * Duplicates the Oval at the specified location or offset.
   * @param {Dynamic} [to] The location of the new Oval, specified in coordinates in the format [x, y]. Can accept: Array of 2 Units, Spread, Page or Layer. 
   * @param {Dynamic} [by] Amount by which to offset the new Oval from the original Oval's position. 
   */
   ...
   * @param {Dynamic} [to] The new location of the Oval,in the format (x, y). Can accept: Array of 2 Units, Spread, Page or Layer. 
   * @param {Dynamic} [by] The amount (in measurement units) to move the Oval relative to its current position, in the format (x, y). 
   */
