...
typedef MultiStateObject = {
  ...
  /*
   * The swatch (color, gradient, tint, or Dynamic ink) applied to the fill of the MultiStateObject. . Can also accept: String.
   */
  ...
  /*
   * The swatch (color, gradient, tint, or Dynamic ink) applied to the stroke of the MultiStateObject. Can also accept: String.
   */
   ...
   */
  function releaseAsObjects():Void;
  /*
   ...
   */
  function addItemsAsState(pageitems:PageItem):Dynamic;
  /*
   ...
   * @param {Dynamic} [around] The point around which to flip the MultiStateObject. Can accept: Array of 2 Units or AnchorPoint enumerator. 
   */
  function flipItem(given:Flip, around:Dynamic):Dynamic;
  /*
   * Duplicates the MultiStateObject at the specified location or offset.
   * @param {Dynamic} [to] The location of the new MultiStateObject, specified in coordinates in the format [x, y]. Can accept: Array of 2 Units, Spread, Page or Layer. 
   * @param {Dynamic} [by] Amount by which to offset the new MultiStateObject from the original MultiStateObject's position. 
   */
   ...
   * @param {Dynamic} [to] The new location of the MultiStateObject,in the format (x, y). Can accept: Array of 2 Units, Spread, Page or Layer. 
   * @param {Dynamic} [by] The amount (in measurement units) to move the MultiStateObject relative to its current position, in the format (x, y). 
   */
   ...
   */
  function getElements():MultiStateObject;
  /*
