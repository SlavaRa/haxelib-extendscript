...
typedef Word = {
  ...
  /*
   * The swatch (color, gradient, tint, or Dynamic ink) applied to the fill of the Word. . Can also accept: String.
   */
  var fillColor:Swatch;
  /*
   * The swatch (color, gradient, tint, or Dynamic ink) applied to the stroke of the Word. Can also accept: String.
   */
