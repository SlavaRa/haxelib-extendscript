...
typedef TextColumn = {
  ...
  /*
   * The swatch (color, gradient, tint, or Dynamic ink) applied to the fill of the TextColumn. . Can also accept: String.
   */
  var fillColor:Swatch;
  /*
   * The swatch (color, gradient, tint, or Dynamic ink) applied to the stroke of the TextColumn. Can also accept: String.
   */
   ...
   */
  function getElements():TextColumn;
  /*
