...
typedef InsertionPoint = {
  ...
  /*
   * The swatch (color, gradient, tint, or Dynamic ink) applied to the fill of the InsertionPoint. . Can also accept: String.
   */
  var fillColor:Swatch;
  /*
   * The swatch (color, gradient, tint, or Dynamic ink) applied to the stroke of the InsertionPoint. Can also accept: String.
   */
   ...
   */
  function getElements():InsertionPoint;
  /*
