...
typedef Text = {
  ...
  /*
   * The swatch (color, gradient, tint, or Dynamic ink) applied to the fill of the Text. . Can also accept: String.
   */
  var fillColor:Swatch;
  /*
   * The swatch (color, gradient, tint, or Dynamic ink) applied to the stroke of the Text. Can also accept: String.
   */
