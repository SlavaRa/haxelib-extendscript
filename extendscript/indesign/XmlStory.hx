...
typedef XmlStory = {
  ...
  /*
   * The swatch (color, gradient, tint, or Dynamic ink) applied to the fill of the XmlStory. . Can also accept: String.
   */
  var fillColor:Swatch;
  /*
   * The swatch (color, gradient, tint, or Dynamic ink) applied to the stroke of the XmlStory. Can also accept: String.
   */
   ...
   */
  function insertLabel(key:String, value:String):PageItem;
  /*
