...
typedef Paragraph = {
   ...
   */
  var bulletsAndNumberingResultText:String;
  /*
   * The current level number value.
   */
  var numberingResultNumber:Float;
  /*
  ...
  /*
   * The swatch (color, gradient, tint, or Dynamic ink) applied to the fill of the Paragraph. . Can also accept: String.
   */
  var fillColor:Swatch;
  /*
   * The swatch (color, gradient, tint, or Dynamic ink) applied to the stroke of the Paragraph. Can also accept: String.
   */
   ...
   */
  function getElements():Paragraph;
  /*
