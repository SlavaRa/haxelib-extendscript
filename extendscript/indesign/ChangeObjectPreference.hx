 ...
 */
typedef ChangeObjectPreference = {
  /*
  ...
  /*
   * The swatch (color, gradient, tint, or Dynamic ink) applied to the fill of the ChangeObjectPreference. . Can return: Swatch or NothingEnum enumerator. Can also accept: String.
   */
  ...
  /*
   * The swatch (color, gradient, tint, or Dynamic ink) applied to the stroke of the ChangeObjectPreference. Can return: Swatch or NothingEnum enumerator. Can also accept: String.
   */
   ...
   */
  function getElements():ChangeObjectPreference;
  /*
