...
typedef RadioButton = {
  ...
  /*
   * The swatch (color, gradient, tint, or Dynamic ink) applied to the fill of the RadioButton. . Can also accept: String.
   */
  ...
  /*
   * The swatch (color, gradient, tint, or Dynamic ink) applied to the stroke of the RadioButton. Can also accept: String.
   */
   ...
   * @param {Dynamic} [around] The point around which to flip the RadioButton. Can accept: Array of 2 Units or AnchorPoint enumerator. 
   */
  function flipItem(given:Flip, around:Dynamic):Dynamic;
  /*
   * Duplicates the RadioButton at the specified location or offset.
   * @param {Dynamic} [to] The location of the new RadioButton, specified in coordinates in the format [x, y]. Can accept: Array of 2 Units, Spread, Page or Layer. 
   * @param {Dynamic} [by] Amount by which to offset the new RadioButton from the original RadioButton's position. 
   */
   ...
   * @param {Dynamic} [to] The new location of the RadioButton,in the format (x, y). Can accept: Array of 2 Units, Spread, Page or Layer. 
   * @param {Dynamic} [by] The amount (in measurement units) to move the RadioButton relative to its current position, in the format (x, y). 
   */
   ...
   */
  function getElements():RadioButton;
  /*
