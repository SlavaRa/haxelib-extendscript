...
typedef ParagraphStyle = {
  ...
  /*
   * The swatch (color, gradient, tint, or Dynamic ink) applied to the fill of the ParagraphStyle. . Can also accept: String.
   */
  var fillColor:Swatch;
  /*
   * The swatch (color, gradient, tint, or Dynamic ink) applied to the stroke of the ParagraphStyle. Can also accept: String.
   */
   ...
   */
  function remove(replacingWith:ParagraphStyle):Dynamic;
  /*
   * Duplicates the ParagraphStyle.
   */
  function duplicate():ParagraphStyle;
  /*
   ...
   */
  function move(to:LocationOptions, reference:Dynamic):ParagraphStyle;
  /*
   * Convert bullets and numbering to text.
   */
  function convertBulletsAndNumberingToText():ParagraphStyle;
  /*
   * Sets the label to the value associated with the specified key.
   * @param {String} key The key.
   * @param {String} value The value.
   */
  function insertLabel(key:String, value:String):ParagraphStyle;
  /*
   ...
   */
  function getElements():ParagraphStyle;
  /*
