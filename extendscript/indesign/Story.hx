...
typedef Story = {
  ...
  /*
   * The swatch (color, gradient, tint, or Dynamic ink) applied to the fill of the Story. . Can also accept: String.
   */
  var fillColor:Swatch;
  /*
   * The swatch (color, gradient, tint, or Dynamic ink) applied to the stroke of the Story. Can also accept: String.
   */
   ...
   */
  var appliedNamedGrid:NamedGrid;
  /*
   ...
   */
  function changecase(using:ChangecaseMode):Dynamic;
  /*
   * Clears the specified types of override.
   * @param {OverrideType} [overridesToClear] The types of override to clear. 
   */
  function clearOverrides(overridesToClear:OverrideType):Dynamic;
  /*
   ...
   */
  function storyEdit():StoryWindow;
  /*
   ...
   */
  function exportFile(format:Dynamic, to:File, showingOptions:Bool, using:PDFExportPreset, versionComments:String, forceSave:Bool):StoryWindow;
  /*
