...
typedef Button = {
   ...
   */
  var animationBehaviors:AnimationBehaviors;
  /*
   * A collection of goto next state behaviors.
   */
  var gotoNextStateBehaviors:GotoNextStateBehaviors;
  /*
   * A collection of goto previous state behaviors.
   */
  var gotoPreviousStateBehaviors:GotoPreviousStateBehaviors;
  /*
   * A collection of goto state behaviors.
   */
  var gotoStateBehaviors:GotoStateBehaviors;
  /*
   * A collection of go to page behavior objects.
   */
  var gotoPageBehaviors:GotoPageBehaviors;
  /*
  ...
  /*
   * The swatch (color, gradient, tint, or Dynamic ink) applied to the fill of the Button. . Can also accept: String.
   */
  ...
  /*
   * The swatch (color, gradient, tint, or Dynamic ink) applied to the stroke of the Button. Can also accept: String.
   */
   ...
   * @param {Dynamic} [around] The point around which to flip the Button. Can accept: Array of 2 Units or AnchorPoint enumerator. 
   */
  function flipItem(given:Flip, around:Dynamic):Dynamic;
  /*
   * Duplicates the Button at the specified location or offset.
   * @param {Dynamic} [to] The location of the new Button, specified in coordinates in the format [x, y]. Can accept: Array of 2 Units, Spread, Page or Layer. 
   * @param {Dynamic} [by] Amount by which to offset the new Button from the original Button's position. 
   */
   ...
   * @param {Dynamic} [to] The new location of the Button,in the format (x, y). Can accept: Array of 2 Units, Spread, Page or Layer. 
   * @param {Dynamic} [by] The amount (in measurement units) to move the Button relative to its current position, in the format (x, y). 
   */
