 ...
 */
typedef ChangeTransliteratePreference = {
  /*
   ...
   */
  var changeCharacterType:Dynamic;
  /*
   ...
   */
  var numberingAlignment:Dynamic;
  /*
   ...
   */
  function getElements():ChangeTransliteratePreference;
  /*
