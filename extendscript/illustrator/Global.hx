...
@:native("") extern class Global {
   ...
   */
  static inline function getApp():Application return untyped (__js__("app"));
  /*
   ...
   */
  static inline function eval(stringExpression:String):Dynamic {
   ...
   */
  static inline function uneval(what:Dynamic):String {
   ...
   */
  static inline function localize(what:String, argument:Dynamic):String {
   ...
   */
  static inline function setDefaultXMLNamespace(namespace:Namespace):Bool {
   ...
   * @param {String} [title] The title of the alert; ignored on the Macintosh
   */
  static inline function confirm(message:String, noAsDefault:Bool, title:String):Bool {
   ...
   */
  static inline function prompt(prompt:String, def:String, title:String):String {
