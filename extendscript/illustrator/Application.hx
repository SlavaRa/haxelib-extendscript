...
typedef Application = {
   ...
   */
  function runAPITest(testName:String):Dynamic;
  /*
   ...
   */
  function aATExecuteSession():String;
  /*
   * Executes the active session in the sequencer.
   * @param {File} file Execute a session file.
   */
  function aATExecuteSessionFromFile(file:File):String;
  /*
   ...
   */
  function doScript(action:String, from:String, dialogs:Bool):String;
  /*
   * Executes a menu command using the menu shortcut string.
   * @param {String} menuCommandString Menu command shortcut.
   */
  function executeMenuCommand(menuCommandString:String):String;
  /*
   ...
   */
  function loadAction(actionFilePath:File):File;
  /*
   ...
   */
  function unloadAction(setName:String, actionName:String):File;
  /*
   ...
   */
  function redraw():DocumentPreset;
  /*
   * Invert a matrix.
   ...
   */
  function open(file:File, ?documentColorSpace:DocumentColorSpace, ?options:Dynamic):Document;
  /*
   ...
   */
  function loadColorSettings(fileSpec:File):String;
  /*
   ...
   */
  function getScriptableHelpGroup():Dynamic;
  /*
   ...
   */
  function reflectCSAW(outputFolder:File):Float;
  /*
