...
typedef FlashPlayer = {
   ...
   * @param {Dynamic} [argument] An argument to pass through to the function.
   */
  function invokePlayerFunction(name:String, argument:Dynamic):Dynamic;
  /*
   * Loads a movie into the Flash Player, and begins playing it.
   * @param {File} file The File object for the SWF file to load.
   */
  function loadMovie(file:File):Dynamic;
  /*
   ...
   */
  function playMovie(rewind:Bool):Dynamic;
  /*
   * Halts playback of the current movie.
   */
  function stopMovie():Dynamic;
  /*
