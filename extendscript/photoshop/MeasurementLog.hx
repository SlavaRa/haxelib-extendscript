...
typedef MeasurementLog = {
   ...
   */
  function exportMeasurements(file:File, range:MeasurementRange, dataPoints:String):Dynamic;
  /*
   * Deletes the specified measurements.
   * @param {MeasurementRange} [range] The measurements to delete. Default: selected.
   */
  function deleteMeasurements(range:MeasurementRange):Dynamic;
};