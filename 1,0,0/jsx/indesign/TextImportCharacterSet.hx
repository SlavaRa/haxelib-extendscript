 ...
 */
typedef TextImportCharacterSet = {
  /*
   ...
   */
  var RECOMMENDSHIFTJIS83PV:Float;
  /*
   * The Shift_JIS 90pv character set.
   */
  var SHIFTJIS90PV:Float;
  /*
   * The Shift_JIS 90ms character set.
   */
  var SHIFTJIS90MS:Float;
  /*
