...
typedef Rectangle = {
  ...
  /*
   * The swatch (color, gradient, tint, or Dynamic ink) applied to the fill of the Rectangle. . Can also accept: String.
   */
  ...
  /*
   * The swatch (color, gradient, tint, or Dynamic ink) applied to the stroke of the Rectangle. Can also accept: String.
   */
   ...
   */
  function clearFrameFittingOptions():PageItem;
  /*
   ...
   */
  function bringToFront(reference:PageItem):PageItem;
  /*
   ...
   */
  function sendToBack(reference:PageItem):PageItem;
  /*
   * Brings the Rectangle forward one level in its layer.
   */
  function bringForward():PageItem;
  /*
   * Sends the Rectangle back one level in its layer.
   */
  function sendBackward():PageItem;
  /*
   ...
   */
  function checkIn(versionComments:String, forceSave:Bool):Bool;
  /*
   ...
   */
  function placeXML(using:XMLElement):Bool;
  /*
   * Tag the object or the parent story using default tags defined in XML preference.
   */
  function autoTag():Bool;
  /*
   * Associates the page item with the specified XML element while preserving existing content.
   * @param {XMLElement} using The XML element.
   */
  function markup(using:XMLElement):Bool;
  /*
   * Places the file.
   ...
   * @param {Dynamic} [around] The point around which to flip the Rectangle. Can accept: Array of 2 Units or AnchorPoint enumerator. 
   */
  function flipItem(given:Flip, around:Dynamic):Dynamic;
  /*
   * Duplicates the Rectangle at the specified location or offset.
   * @param {Dynamic} [to] The location of the new Rectangle, specified in coordinates in the format [x, y]. Can accept: Array of 2 Units, Spread, Page or Layer. 
   * @param {Dynamic} [by] Amount by which to offset the new Rectangle from the original Rectangle's position. 
   */
   ...
   * @param {Dynamic} [to] The new location of the Rectangle,in the format (x, y). Can accept: Array of 2 Units, Spread, Page or Layer. 
   * @param {Dynamic} [by] The amount (in measurement units) to move the Rectangle relative to its current position, in the format (x, y). 
   */
   ...
   */
  function getElements():Rectangle;
  /*
