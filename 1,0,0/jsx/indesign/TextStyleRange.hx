...
typedef TextStyleRange = {
  ...
  /*
   * The swatch (color, gradient, tint, or Dynamic ink) applied to the fill of the TextStyleRange. . Can also accept: String.
   */
  var fillColor:Swatch;
  /*
   * The swatch (color, gradient, tint, or Dynamic ink) applied to the stroke of the TextStyleRange. Can also accept: String.
   */
   ...
   */
  function getElements():TextStyleRange;
  /*
